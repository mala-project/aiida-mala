The aiida-mala plugin for `AiiDA`_
=====================================================

``aiida-mala`` is available at http://github.com/pcagas/aiida-mala
...
.. toctree::
   ...
   API documentation <apidoc/aiida_mala>
...
``aiida-mala`` is released under the MIT license.
