#
# Sphinx configuration for aiida-mala
#
...
copyright_owners = "MALA Developers"
...
release = aiida_mala.__version__
...
html_title = f"aiida-mala v{release}"
html_theme_options = {}
...
html_use_opensearch = "https://aiida-mala.readthedocs.io"
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, "src", "aiida_mala")
